...
- **Sample rate control**: `ICV_SEARCH_LOG_SAMPLE_RATE` setting (0.0 to 1.0) controls what fraction of individual `SearchQueryLog` rows are written; aggregate counts are always recorded at 100%
